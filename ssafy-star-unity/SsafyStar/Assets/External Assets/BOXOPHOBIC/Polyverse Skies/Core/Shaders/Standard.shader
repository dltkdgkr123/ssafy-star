...
Shader "BOXOPHOBIC/Polyverse Skies/Standard"
{
	Properties
	{
		...
		[ASEEnd][StyledVector(18)]_SkyboxRotationAxis("Skybox Rotation Axis", Vector) = (0,1,0,0)
	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_7_0_g23 = -1.0;
				#ifdef _ENABLESTARS_ON
				float staticSwitch947 = saturate( ( ( dotResult732 - temp_output_7_0_g23 ) / ( -( 1.0 - _StarsSunMask ) - temp_output_7_0_g23 ) ) );
				#else
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g22 = 0.0;
				float4 lerpResult288 = lerp( _EquatorColor , lerpResult180 , pow( saturate( ( ( abs( VertexPos1239.y ) - temp_output_7_0_g22 ) / ( _EquatorHeight - temp_output_7_0_g22 ) ) ) , ( 1.0 - _EquatorSmoothness ) ));
				...
				float saferPower554 = abs( tex2D( _TwinklingTexture, vertexToFrag761 ).r );
				...
				#endif
				float temp_output_314_0 = abs( VertexPos1239.y );
				float temp_output_7_0_g26 = 0.0;
				float lerpResult678 = lerp( saturate( pow( ( ( temp_output_314_0 - temp_output_7_0_g26 ) / ( _FogHeight - temp_output_7_0_g26 ) ) , ( 1.0 - _FogSmoothness ) ) ) , 0.0 , _FogFill);
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.RangedFloatNode;1265;-896,-5488;Inherit;False;Property;_SkyboxOffset;Skybox Offset;62;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;1269;-608,-5488;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1233;-896,-5216;Inherit;False;Property;_SkyboxRotation;Skybox Rotation;63;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1238;-896,-5376;Inherit;False;Property;_SkyboxRotationAxis;Skybox Rotation Axis;64;0;Create;True;0;0;0;False;1;StyledVector(18);False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1208;-256,-1216;Half;False;Property;_StarsRotationSpeed;Stars Rotation Speed;30;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1211;-256,-1376;Half;False;Property;_StarsRotation;Stars Rotation;28;1;[IntRange];Create;True;0;0;0;False;1;Space(10);False;360;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;938;-896,-128;Half;False;Global;GlobalSunDirection;GlobalSunDirection;38;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;1228;-256,-1536;Inherit;False;Property;_StarsRotationAxis;Stars Rotation Axis;29;0;Create;True;0;0;0;False;1;StyledVector(18);False;0,1,0;1,1,9.48;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.StaticSwitch;956;0,-896;Float;False;Property;_ENABLESTARS_ON;Enable Stars;15;0;Create;False;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Reference;918;False;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;1292;0,-3328;Inherit;False;Remap To 0-1;-1;;22;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1221;768,-1792;Float;False;Property;_EnableStarsRotation;Enable Stars Rotation;27;0;Create;True;0;0;0;False;1;Space(10);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;260;-896,2624;Half;False;Property;_CloudsRotationSpeed;Clouds Rotation Speed;54;0;Create;True;0;0;0;False;0;False;0.5;-0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-896,2464;Half;False;Property;_CloudsRotation;Clouds Rotation;52;0;Create;True;0;0;0;False;1;Space(10);False;1;360;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1291;3328,-1792;Inherit;False;Remap To 0-1;-1;;23;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;-1;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;975;0,128;Half;False;Property;_SunSize;Sun Size;35;0;Create;True;0;0;0;False;0;False;0.5;1;0.1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1376;-896,2304;Inherit;False;Property;_CloudsRotationAxis;Clouds Rotation Axis;53;0;Create;True;0;0;0;False;1;StyledVector(18);False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1046;256,1280;Half;False;Property;_MoonSize;Moon Size;43;0;Create;True;0;0;0;False;0;False;0.5;1;0.1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;241;1024,2384;Half;False;Property;_CloudsHeight;Clouds Height;48;0;Create;True;0;0;0;False;1;Space(10);False;0;0;-0.5;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;1164;640,2240;Float;False;Property;_EnableCloudsRotation;Enable Clouds Rotation;51;0;Create;True;0;0;0;False;1;Space(10);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;996;2176,320;Half;False;Property;_SunIntensity;Sun Intensity;36;0;Create;True;0;0;0;False;0;False;1;0.84;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;998;2176,96;Half;False;Property;_SunColor;Sun Color;34;0;Create;True;0;0;0;False;1;Space(10);False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;1057;1504,897;Float;False;Property;_ENABLEMOON_ON;Enable Moon;40;0;Create;False;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Reference;1113;False;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1045;2176,1408;Half;False;Property;_MoonIntensity;Moon Intensity;44;0;Create;True;0;0;0;False;0;False;1;0.33;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1052;3424,1328;Float;False;Property;_ENABLEMOON_ON;Enable Moon;40;0;Create;False;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Reference;1113;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1048;2176,1152;Half;False;Property;_MoonColor;Moon Color;42;0;Create;True;0;0;0;False;1;Space(10);False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;41;1856,2240;Inherit;True;Property;_CloudsCubemap;Clouds Cubemap;47;1;[NoScaleOffset];Create;True;0;0;0;False;2;Space(10);StyledTextureSingleLine;False;-1;None;5bf545dec997743419de1df4195b3a0d;True;0;False;black;LockedToCube;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1112;640,-6688;Inherit;False;1004;SUN;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;325;-896,3520;Half;False;Property;_FogSmoothness;Fog Smoothness;59;0;Create;True;0;0;0;False;0;False;0;0;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;313;-896,3392;Half;False;Property;_FogHeight;Fog Height;58;0;Create;True;0;0;0;False;1;Space(10);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;232;2688,2048;Half;False;Property;_CloudsShadowColor;Clouds Shadow Color;50;0;Create;True;0;0;0;False;0;False;0.4980392,0.7450981,1,1;1,0.1843134,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;261;2688,2208;Half;False;Property;_CloudsLightColor;Clouds Light Color;49;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;1287;-320,3376;Inherit;False;Remap To 0-1;-1;;26;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;919;1152,-6912;Float;False;Property;_EnableSun;Enable Sun;32;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;679;128,3520;Half;False;Property;_FogFill;Fog Fill;60;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1113;1664,-6912;Float;False;Property;_EnableMoon;Enable Moon;40;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;1120;2688,-6912;Float;False;Property;_EnableClouds;Enable Clouds;46;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1108;-512,3328;Half;False;Constant;_Float39;Float 39;55;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1240;496,-7680;Half;False;Property;_SkyboxCat;[ Skybox Cat ];61;0;Create;True;0;0;0;True;1;StyledCategory(Skybox Settings);False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1226;-896,3648;Inherit;False;Property;_EnableFogMessage;EnableFogMessage;57;0;Create;True;0;0;0;True;1;StyledMessage(Info, The fog color is controlled by the fog color set in the Lighting panel., _EnableBuiltinFog, 1, 10, 0);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;921;3456,-6912;Float;False;Property;_EnableBuiltinFog;Enable Fog;56;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;315;-320,3200;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1183;160,-7680;Half;False;Property;_CloudsCat;[ Clouds Cat ];45;0;Create;True;0;0;0;True;1;StyledCategory(Clouds);False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1109;-512,3424;Half;False;Constant;_Float40;Float 40;55;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1407;2965.669,-28.96188;Inherit;False;Remap To 0-1;-1;;27;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1409;2588.669,94.03812;Half;False;Property;_SunAlphaMax;Sun Alpha Max;38;0;Create;True;0;0;0;False;0;False;1;0.84;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1408;2595.669,28.03812;Half;False;Property;_SunAlphaMin;Sun Alpha Min;37;0;Create;True;0;0;0;False;0;False;0;0.84;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;1410;3215.669,21.03812;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1181;336,-7680;Half;False;Property;_FogCat;[ Fog Cat ];55;0;Create;True;0;0;0;True;1;StyledCategory(Fog);False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1189;0,-7680;Half;False;Property;_MoonCat;[ Moon Cat ];39;0;Create;True;0;0;0;True;1;StyledCategory(Moon);False;1;1;1;1;0;1;FLOAT;0
...
WireConnection;1292;6;287;0
WireConnection;1292;8;212;0
...
WireConnection;1291;6;732;0
WireConnection;1291;8;740;0
...
WireConnection;1287;6;314;0
WireConnection;1287;8;313;0
...
WireConnection;1407;6;995;4
WireConnection;1407;7;1408;0
WireConnection;1407;8;1409;0
WireConnection;1410;0;1407;0
WireConnection;1180;0;921;0
ASEEND*/
//CHKSM=C3B367FE534BAB0649364A4476BF1C4811F0F41A